...
export class HomeComponent {
  protected message = "Bonjour,  \n" +
    "Je m'appelle Catherine, passionnée de cuisine, Pour moi, chaque recette est une occasion de rendre les gens heureux, de partager un moment de convivialité autour d'un plat savoureux avec mes amies ou ma famille. Mes recettes ne sont pas seulement un plaisir gustatif, elles sont un véritable symbole de partage et de convivialité. J'ai à cœur de vous transmettre mon amour de la cuisine et de vous inviter à découvrir des saveurs qui réchauffent le cœur.  \n" +
